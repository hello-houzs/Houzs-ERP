...
const STAGE_COPY: Record<string, { step: 1 | 2 | 3 | 4 | 5; eyebrow: string; title: string; body: string }> = {
  ...
  pending_inspection:       { step: 2, eyebrow: "In progress",      title: "Inspecting the issue",             body: "Our team is assessing the reported issue — from your photos or an on-site check — before we confirm the fix." },
