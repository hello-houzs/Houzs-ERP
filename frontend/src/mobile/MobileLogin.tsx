  ...
  return (
    <div className="hz-m" style={{ position: "fixed", inset: 0, background: "var(--dark)", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "34px 28px", maxWidth: 460, margin: "0 auto" }}>
        <div className="appicon hz-lg-item" style={{ ...delay(0), marginBottom: 18 }}>
          <img src="/logo-mark.png" alt="Houzs Century" style={{ width: 40, height: 40, objectFit: "contain", filter: "brightness(0) invert(1)" }} />
        </div>
        <div className="hz-lg-item" style={{ ...delay(1), fontSize: 28, fontWeight: 800, color: "#fff", letterSpacing: "-.01em", lineHeight: 1 }}>HOUZS</div>
        <div className="hz-lg-item" style={{ ...delay(1), fontSize: 9, fontWeight: 700, letterSpacing: ".38em", color: "var(--gold)", marginTop: 5 }}>CENTURY · ERP</div>
