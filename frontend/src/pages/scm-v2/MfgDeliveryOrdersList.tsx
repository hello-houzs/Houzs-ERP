...
type DoRow = {
  ...
  /* Migration 0057 — drop-ship flag (dual-read camelCase from the pg driver). */
  is_dropship?: boolean;
  isDropship?: boolean;
};
...
export const MfgDeliveryOrdersList = () => {
  ...
  const onNew = () => navigate('/scm/delivery-orders/new');
    ...
    <div className={styles.page}>
      <div className={styles.headerRow}>
        ...
        <div style={{ display: 'inline-flex', gap: 'var(--space-2)' }}>
          <Button variant="ghost" size="sm" onClick={() => navigate('/scm/delivery-orders/from-so')}>
  ...
  },
  {
    ...
    accessor: (r) => (
      <span style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 4, alignItems: 'center' }}>
        ...
        {/* Drop-ship badge (mig 0057) — warning tone. Dual-read camelCase. */}
