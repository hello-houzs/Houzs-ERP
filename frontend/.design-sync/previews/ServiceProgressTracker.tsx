...
// 8-node ASSR workflow stepper (Pending Inspection retired mig 0105 —
// inspection lives inside Under Verification now). Completed = green
...
// ASSR-0231 — mid-flight, inside SLA at stage 4 (Pending Item Pickup).
const ON_TRACK = [
  hist(1, "pending_review", 9, 8.2, 1),
  hist(2, "under_verification", 8.2, 6.5, 2),
  hist(3, "pending_solution", 6.5, 5.1, 2),
  hist(4, "pending_item_pickup", 0.5, null, 2),
];

// ASSR-0207 — stage 5 breaching SLA; item pickup skipped (unit already at
...
const SLA_BREACH = [
  ...
  hist(14, "pending_item_pickup", 8.2, 8.2, 2, {
    skipped: 1,
    skip_reason: "Unit already at supplier — collected on-site during inspection",
  }),
  hist(15, "pending_supplier_pickup", 5.4, null, 2),
];
...
const NEAR_DONE = [
  ...
  hist(24, "pending_item_pickup", 14.5, 13, 2),
  hist(25, "pending_supplier_pickup", 13, 8, 2),
  hist(26, "pending_item_ready", 8, 1.6, 5),
  hist(27, "pending_delivery_service", 1.6, null, 2),
];

export const OnTrack = () => (
  <div className="w-[46rem]">
    <ServiceProgressTracker currentStage={"pending_item_pickup" as any} history={ON_TRACK as any} />
  </div>
);
