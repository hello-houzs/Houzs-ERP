...
// merely VIEWING the stock listing. Viewing the Inventory page (stock card /
// listing / warehouses) stays on `scm.warehouse.inventory`; this write is gated
// on `scm.warehouse.adjustments`.
//
