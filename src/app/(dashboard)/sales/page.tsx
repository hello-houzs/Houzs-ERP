...
function TreeRow({ node, collapsed, onToggle, onEdit, isLast, parentGuides }: {
  ...
  return (
    <div
      ...
      onClick={onEdit}
    >
      {/* Tree guide lines — absolutely positioned over the row */}
      {depth > 0 && (
        <>
          ...
          {/* Current level: vertical line (half if last) + horizontal connector */}
          <div
    ...
    <div className="flex flex-col items-center">
      ...
      {children.length > 0 && (
        <>
          ...
          {children.length === 1 ? (
            /* Single child — just vertical line down */
            <div className="flex flex-col items-center">
              <OrgChartNode node={children[0]} onEdit={onEdit} />
            </div>
          ) : (
            /* Multiple children — horizontal bar + vertical lines */
            <div className="flex flex-col items-center">
