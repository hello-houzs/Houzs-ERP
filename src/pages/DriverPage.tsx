    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-[#DDE5E5] bg-white overflow-hidden">
        ...
        {master.drivers.length === 0 ? (
          <div className="p-6 text-center text-[11px] text-gray-400">
            No drivers yet — add them in <Link to="/settings" className="text-[#0F766E] font-semibold hover:underline">Master Data</Link>
          </div>
        ) : (
      ...
      <div className="rounded-lg border border-[#DDE5E5] bg-white overflow-hidden">
        ...
        {master.lori.length === 0 ? (
          <div className="p-6 text-center text-[11px] text-gray-400">
            No lori yet — add them in <Link to="/settings" className="text-[#0F766E] font-semibold hover:underline">Master Data</Link>
          </div>
        ) : (
