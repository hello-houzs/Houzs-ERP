...
| 2026-07-20 | B01/B02 payment retry + browser recovery close-out | `bcbeebc1`; 66 files / 650 tests; typecheck + build 2,490 modules; initial 162.9/165.0 KB gzip; total 1,792.2/1,800.0 KB gzip; largest chunk 429.5/600 KB; emitted SW + focused-test gate + exact-build smoke 2/2 | SO/SI payments are durably staged before send, isolated per user/company/document/intent and expire before backend idempotency retention; created-document retries cannot duplicate documents or trap empty intents. Mail/storage/RouteFallback recovery is bounded and tested. Independent review P0=0/P1=0. Backend code/schema/runtime and workflow diff: 0. |
