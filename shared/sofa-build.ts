...
export const cellEdges = (cell: Cell): EdgeType[] => {
  ...
  // SEAM: widened from the tuple type to `EdgeType[] | undefined` so the
  // representative-fallback assignment below type-checks under Houzs's stricter
  // noUncheckedIndexedAccess (2990s's tsconfig didn't flag the indexed access).
